    ...
    <section className="w-full bg-global-2 relative">
      ...
      <div className="w-full max-w-[1102px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="pt-[25px] pb-[25px] md:pt-[50px] md:pb-[50px]">
          ...
          <h1 className="font-anton uppercase text-global-8 text-[50px] sm:text-[75px] md:text-[90px] leading-[55px] sm:leading-[83px] md:leading-[110px] max-w-[1102px] relative">
            {title}{' '}
            {underlineWord && (
            ...
            {description && (
              <span className="ml-4 align-top inline-flex flex-col items-start max-w-[520px] md:mt-8 md:ml-8">
