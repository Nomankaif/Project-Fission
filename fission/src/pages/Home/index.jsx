...
const Home = () => {
    ...
    <div className="">
      ...
      <section>
        <HeroSection
          ...
          title="Empowering Your Business Through Reliable IT"
      ...
      <section className="w-full bg-global-9">
        <div className="w-full max-w-[1102px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-[31px] sm:py-[46px] md:py-[62px]">
            <div className="flex flex-col items-start ">
              <div className="relative w-full  ">
                <div className="bg-global-4 rounded-[16px] px-[20px] py-[2px]  w-[280px] mb-[14px] ">
                  <span className="text-[16px] sm:text-[18px] md:text-[20px] font-dm-sans font-bold leading-[22px] sm:leading-[24px] md:leading-[27px]  uppercase text-global-2">
                    Industry Expertise
                  </span>
                </div>
                <div className="flex flex-col items-center gap-[15px] md:gap-[30px]">
                  {/* Header */}
                  <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-[20px] lg:gap-0">
                    <h2 className="text-[50px] sm:text-[65px] md:text-[80px] font-anton font-normal leading-[60px] sm:leading-[70px] md:leading-[80px] text-left uppercase text-global-1 w-full lg:w-[32%]">
                      Industries We Serve
                    </h2>
                    <div className="flex flex-col lg:items-end w-full lg:w-[46%]">
                      <p className="text-[14px] sm:text-[16px] md:text-[18px] font-dm-sans font-normal leading-[20px] sm:leading-[23px] md:leading-[26px] text-left lg:text-left text-global-4 mb-[10px] lg:mb-[20px]">
                      ...
                      <div className="flex items-center gap-[10px] md:gap-[20px]">
                        <img
                          ...
                          alt="Previous"
                          className="w-[35px] h-[35px] md:w-[50px] md:h-[30px] cursor-pointer hover:opacity-70 transition-opacity"
                        />
                        <img
                  ...
                  {/* Industry Cards */}
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-[20px] sm:gap-[30px] md:gap-[70px] w-full mt-[20px] md:mt-[40px]">
                    {/* Card Component */}
                    {[
                      {
                      ...
                      <div key={index} className="flex flex-col items-center w-full sm:w-[300px]">
                        <div className="relative w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] mb-[15px] md:mb-[30px]">
                          <img
                            src={card.img}
                            alt={card.title}
                          ...
                          />
                          {/* Number Overlay */}
                          <span className="absolute bottom-[-15px] right-[-15px] text-[80px] sm:text-[100px] md:text-[120px] font-anton font-bold text-white opacity-80 leading-none">
                            {card.number}
                          </span>
                        </div>
                        <h3 className="text-[20px] sm:text-[25px] md:text-[30px] font-anton font-normal leading-[24px] sm:leading-[30px] md:leading-[35px] text-center uppercase text-global-1">
                          {card.title}
                        </h3>
                      </div>
                    ))}
                  ...
                  {/* Bottom Text */}
                  <p className="text-[16px] sm:text-[18px] md:text-[20px] font-dm-sans font-normal italic leading-[22px] sm:leading-[25px] md:leading-[28px] text-center text-global-4 mt-[20px] md:mt-[40px] max-w-[780px]">
        ...
        {/* Side Image */}
        <div className="absolute right-0 top-[3463px] w-[132px] sm:w-[198px] md:w-[264px] h-[153px]  md:h-[306px]">
          <img
      ...
      <section className="w-full bg-global-3 relative">
        <div className="absolute left-0 top-0 w-[104px] sm:w-[156px] md:w-[208px] h-[250px] sm:h-[375px] md:h-[500px]">
          <img
            src="/images/img_mask_group.png"
            alt="Background"
            className="w-full h-full object-cover"
  ...
  {stepsData.map((step) => (
    <div key={step.id}>
      {/* Step Row */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-[10px] sm:gap-0 mb-[9px] md:mb-[18px]">
        {/* Number + Title + Description */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-[12px] md:gap-[20px] flex-1">
          ...
          <h3 className="text-[30px] sm:text-[40px] md:text-[50px] font-anton font-normal leading-[45px] sm:leading-[60px] md:leading-[76px] uppercase text-global-8 whitespace-nowrap">
            {step.title}
          </h3>

          {openStep === step.id && (
            <p className="text-[14px] sm:text-[16px] md:text-[18px] font-dm-sans font-normal leading-[20px] sm:leading-[23px] md:leading-[26px] text-global-4">
              {step.description}
            </p>
          )}
        </div>
        ...
        <button
          ...
          className="flex items-center justify-center w-[35px] h-[35px] md:w-[50px] md:h-[50px] rounded-full border border-global-10 text-global-10 hover:bg-global-10 hover:text-global-1 transition"
        >
      ...
      {/* Divider */}
      <div className="w-full h-[1px] bg-global-7 mb-[8px] md:mb-[16px]"></div>
    </div>
  ))}
  ...
  <div className="flex justify-end mt-[24px] md:mt-[48px]">
    ...
    >
      ...
      <section className="w-full bg-global-9 relative">
        <div className="w-full max-w-[1102px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-[45px] sm:py-[68px] md:py-[90px]">
            <div className="flex flex-col items-center">
              {/* Heading */}
              <div className="flex flex-col items-start w-full mb-[12px] md:mb-[20px]">
                <h2 className="text-[48px] sm:text-[65px] md:text-[80px] font-anton uppercase text-global-1 leading-[60px] sm:leading-[70px] md:leading-[80px] w-full lg:w-[64%]">
                  Success Stories & Case Studies
                </h2>
                <img
                  src="/images/img_vector_1.svg"
                  alt="Decorative underline"
                  className="w-[112px] sm:w-[168px] md:w-[224px] h-[18px] sm:h-[27px] md:h-[36px] -mt-2 md:-mt-4 ml-[87px] "
                />
              </div>

              {/* Main Case Study */}
              <div className="flex flex-col lg:flex-row items-start justify-center  gap-[20px] lg:gap-[40px] w-full mb-[30px] md:mb-[60px] ">
                {/* Image with green box */}
                <div className="relative w-full lg:w-[408px] h-[250px] sm:h-[350px] lg:h-[418px] md:ml-32 ">
                  <img
                    src="/images/img_rectangle_27.png"
                    alt="Healthcare Platform"
                    className="w-3/2 h-full object-cover rounded-[40px]"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent rounded-[40px]" />

                  {/* Green Box at Bottom Left */}
                  <div className="absolute left-[-180px] bottom-[40px] bg-gradient-to-r from-white to-[#a1f480] rounded-[20px] p-[10px] sm:p-[15px] md:p-[20px] shadow-[4px_4px_15px_#4bc31c66] border border-transparent w-[80%] sm:w-[70%]">
                    <p className="text-[20px] sm:text-[15px] md:text-[20px] font-anton uppercase text-global-1">
                ...
                <div className="flex flex-col gap-[6px] md:gap-[10px] w-full lg:w-[26%] lg:mt-[0px] mt-[15px]">
                  ...
                  <p className="text-[16px] sm:text-[18px] md:text-[20px] font-dm-sans italic text-global-3">
                    ...
                    <span className="font-bold">
                      HealthCo handle 5× user growth without a glitch, while improving UX.
                    </span>
                  </p>
                </div>
              </div>
              ...
              {/* Case Studies Grid */}
              <div className="flex flex-col sm:flex-row gap-[15px] md:gap-[30px] w-full px-[28px] sm:px-[42px] md:px-[56px]">
                {[
                  {
                  ...
                  },
                  {
                    ...
                    desc: 'Improved customer targeting and sales forecasting in effecient way.',
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col gap-[10px] md:gap-[20px] items-center w-full sm:w-[294px]"
                  >
                    <div className="flex flex-col gap-[4px] md:gap-[8px] items-start w-full pl-[5px]">
                      <h4 className="text-[20px] sm:text-[25px] md:text-[30px] font-anton uppercase text-global-1">
                        {item.title}
                      </h4>
                      <div className="w-[14px] sm:w-[21px] md:w-[28px] h-[2px] bg-global-1" />
                      <p className="text-[16px] sm:text-[18px] md:text-[20px] font-dm-sans italic font-light text-global-1">
                        {item.desc}
                      </p>
                    </div>
                    <img
